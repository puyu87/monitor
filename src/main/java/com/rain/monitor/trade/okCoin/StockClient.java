...
public class StockClient {
	...
	public static void main(String[] args) throws HttpException, IOException{
	    ...
	    */
	    ...
	    //现货行情
		String btc_usd = stockGet.ticker("btc_usd");

		//现货市场深度
		String btc_usd1 = stockGet.depth("btc_usd");

		//现货OKCoin历史交易信息
		String btc_usd2 = stockGet.trades("btc_usd", "20");
	    ...
	    //现货获取用户订单信息
		String btc_usd3 = stockPost.order_info("btc_usd", tradeOrderV1);

		//现货撤销订单
		String btc_usd4 = stockPost.cancel_order("btc_usd", tradeOrderV1);
