 ...
 */
public class Sequence48Minitor extends MinitorBase{


    static String HOST = "http://172.18.4.48:15555";
    @Override
    public void execute() {
                        ...
                        if ("convertToPngQueue".equalsIgnoreCase(jsonObject.getString("name"))) {
                            ...
                            if (messages != null && messages.length() > 0) {
                                if (Long.parseLong(messages) > 100) {
                                    ...
                                    String title = "切题服务["+HOST+"]监控报错，队列[convertToPngQueue]数值["+messages+"]";
